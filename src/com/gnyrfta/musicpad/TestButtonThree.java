...
public class TestButtonThree extends ImageButton {
	private int soundToPlay;
	public TestButtonThree(final Context context, final AttributeSet attrs) {
		super(context, attrs);
	...
	public boolean onTouchEvent(final MotionEvent event) {
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			Pad.mSoundPoolHelper.play(Pad.soundIdLL);
		}

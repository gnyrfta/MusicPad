...
public class TestButtonTwo extends ImageButton {
	private int soundToPlay=0;

	public TestButtonTwo(final Context context, final AttributeSet attrs) {
		super(context, attrs);
	...
	public boolean onTouchEvent(final MotionEvent event) {
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			Pad.mSoundPoolHelper.play(Pad.soundIdUR);
		}
